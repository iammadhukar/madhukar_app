...
class _$EmployeeDao extends EmployeeDao {
  _$EmployeeDao(
    ...
    this.changeListener,
        ...
        _empDataModelInsertionAdapter = InsertionAdapter(
            database,
            'employee_data',
  ...
  @override
  Future<void> deleteEmployee(EmpDataModel employee) async {
    await _empDataModelDeletionAdapter.delete(employee);
  }
}
